...
import com.example.movieapp.databinding.RatedMovieRowBinding
...
class TopRatedConcatAdapter (private val moviesAdapter: MovieAdapter): RecyclerView.Adapter<BaseConcatHolder<*>>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseConcatHolder<*> {
        val itemBinding = RatedMovieRowBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    private inner class ConcatViewHolder(val binding: RatedMovieRowBinding) : BaseConcatHolder<MovieAdapter>(binding.root){
